...
//	@Autowired
	...
	public RestaurantDetailView getRestaurantDetail(Long restaurantId) {
		...
		return RestaurantDetailView.builder().id(restaurant.getId()).name(restaurant.getName()).address(restaurant.getAddress())
											.createdAt(restaurant.getCreatedAt()).updatedAt(restaurant.getUpdatedAt())
											.menus(
